...
namespace Задача_20
{
    ...
    
    {
            ...
            static void Main(string[] args)
            {
                ...
                Console.WriteLine($"Площадь круга с радиусом {radius} составляет {circumference(radius)}");

                circumference = GetAreaOfCircle;
                Console.WriteLine($"Объём шара с радиусом {radius} составляет {circumference(radius)}");
